...
describe Bank do
  ...
  let(:transaction1) { double(:transaction, date: '10/01/2012', amount: -1000) }
  let(:transaction2) { double(:transaction, date: '15/01/2012', amount: 2500) }
  let(:history) { [{transaction: transaction1, balance: -1000},
                   {transaction: transaction1, balance:  1500}] }
